...
#define IEC958_AES0_NONAUDIO_SHIFT	1	/* non audio shift */
#define IEC958_AES0_NONAUDIO		(1<<1)	/* 0 = audio, 1 = non-audio */
#define IEC958_AES0_PRO_EMPHASIS_SHIFT	2	/* shift - emphasis */
...
#define IEC958_AES0_PRO_FS_SHIFT	6	/* shift - sample frequency */
...
#define IEC958_AES0_CON_NOT_COPYRIGHT_SHIFT	2	/* copyright shift */
#define IEC958_AES0_CON_NOT_COPYRIGHT	(1<<2)	/* 0 = copyright, 1 = not copyright */
#define IEC958_AES0_CON_EMPHASIS_SHIFT	3	/* shift - emphasis */
...
#define IEC958_AES0_CON_MODE_SHIFT	6	/* shift - mode */
#define IEC958_AES0_CON_MODE		(3<<6)	/* mask - mode */
#define IEC958_AES1_PRO_MODE_SHIFT	0	/* shift - channel mode */
...
#define IEC958_AES1_PRO_USERBITS_SHIFT	4	/* shift - user bits */
...
#define IEC958_AES2_PRO_SBITS_SHIFT	0	/* shift - sample bits */
...
#define IEC958_AES2_PRO_WORDLEN_SHIFT	3	/* shift - source word length */
...
#define IEC958_AES2_CON_SOURCE_SHIFT	0	/* shift - source number */
#define IEC958_AES2_CON_SOURCE		(15<<0)	/* mask - source number */
#define IEC958_AES2_CON_SOURCE_UNSPEC	(0<<0)	/* unspecified */
#define IEC958_AES2_CON_CHANNEL_SHIFT	4	/* shift - channel number */
#define IEC958_AES2_CON_CHANNEL		(15<<4)	/* mask - channel number */
#define IEC958_AES2_CON_CHANNEL_UNSPEC	(0<<4)	/* unspecified */
#define IEC958_AES3_CON_FS_SHIFT	0	/* shift - sample frequency */
...
#define IEC958_AES3_CON_CLOCK_SHIFT	4	/* shift - clock accuracy */
#define IEC958_AES3_CON_CLOCK		(3<<4)	/* mask - clock accuracy */
#define IEC958_AES3_CON_CLOCK_1000PPM	(0<<4)	/* 1000 ppm */
#define IEC958_AES3_CON_CLOCK_50PPM	(1<<4)	/* 50 ppm */
#define IEC958_AES3_CON_CLOCK_VARIABLE	(2<<4)	/* variable pitch */
#define IEC958_AES4_CON_MAX_WORDLEN_24	(1<<0)	/* 0 = 20-bit, 1 = 24-bit */
#define IEC958_AES4_CON_WORDLEN_SHIFT	1	/* shift - sample word length */
...
#define IEC958_AES4_CON_ORIGFS_SHIFT	4	/* shift - orig. sample freq */
...
#define IEC958_AES5_CON_CGMSA_SHIFT	0	/* shift - CGMS-A */
 ...
 *                                                                          *
 ****************************************************************************/
#define CEA861_AUDIO_INFOFRAME_DB1CC_SHIFT		0
#define CEA861_AUDIO_INFOFRAME_DB1CC_MASK		(7<<0)
#define CEA861_AUDIO_INFOFRAME_DB1CT_SHIFT		4
#define CEA861_AUDIO_INFOFRAME_DB1CT_MASK		(0xf<<4)
#define CEA861_AUDIO_INFOFRAME_DB1CT_FROM_STREAM	0
#define CEA861_AUDIO_INFOFRAME_DB1CT_IEC60958	1
#define CEA861_AUDIO_INFOFRAME_DB1CT_AC3		2
#define CEA861_AUDIO_INFOFRAME_DB1CT_MPEG1		3
#define CEA861_AUDIO_INFOFRAME_DB1CT_MP3		4
#define CEA861_AUDIO_INFOFRAME_DB1CT_MPEG2_MULTICH	5
#define CEA861_AUDIO_INFOFRAME_DB1CT_AAC		6
#define CEA861_AUDIO_INFOFRAME_DB1CT_DTS		7
#define CEA861_AUDIO_INFOFRAME_DB1CT_ATRAC		8
#define CEA861_AUDIO_INFOFRAME_DB1CT_ONEBIT	9
#define CEA861_AUDIO_INFOFRAME_DB1CT_DOLBY_DIG_PLUS 10
#define CEA861_AUDIO_INFOFRAME_DB1CT_DTS_HD	11
#define CEA861_AUDIO_INFOFRAME_DB1CT_MAT		12
#define CEA861_AUDIO_INFOFRAME_DB1CT_DST		13
#define CEA861_AUDIO_INFOFRAME_DB1CT_WMA_PRO	14
#define CEA861_AUDIO_INFOFRAME_DB2SF_SHIFT		2
#define CEA861_AUDIO_INFOFRAME_DB2SF_MASK		(7<<2)
#define CEA861_AUDIO_INFOFRAME_DB2SF_FROM_STREAM	0
#define CEA861_AUDIO_INFOFRAME_DB2SF_32000		1
#define CEA861_AUDIO_INFOFRAME_DB2SF_44100		2
#define CEA861_AUDIO_INFOFRAME_DB2SF_48000		3
#define CEA861_AUDIO_INFOFRAME_DB2SF_88200		4
#define CEA861_AUDIO_INFOFRAME_DB2SF_96000		5
#define CEA861_AUDIO_INFOFRAME_DB2SF_176400	6
#define CEA861_AUDIO_INFOFRAME_DB2SF_192000	7
#define CEA861_AUDIO_INFOFRAME_DB2SS_SHIFT		0
#define CEA861_AUDIO_INFOFRAME_DB2SS_MASK		(3<<0)
#define CEA861_AUDIO_INFOFRAME_DB2SS_FROM_STREAM	0
#define CEA861_AUDIO_INFOFRAME_DB2SS_16BIT		1
#define CEA861_AUDIO_INFOFRAME_DB2SS_20BIT		2
#define CEA861_AUDIO_INFOFRAME_DB2SS_24BIT		3
#define CEA861_AUDIO_INFOFRAME_DB5_DM_INH_SHIFT	7
#define CEA861_AUDIO_INFOFRAME_DB5_DM_INH_MASK	(1<<7)
#define CEA861_AUDIO_INFOFRAME_DB5_DM_INH_PERMITTED 0
#define CEA861_AUDIO_INFOFRAME_DB5_DM_INH_PROHIBITED 1
#define CEA861_AUDIO_INFOFRAME_DB5_LSV_SHIFT	3
#define CEA861_AUDIO_INFOFRAME_DB5_LSV_MASK	(0xf<<3)
